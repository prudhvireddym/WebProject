...
public class soundDetect extends Activity {
    ...
    /** config state **/
    private int mThreshold =8;//Integer.parseInt(getIntent().getStringExtra("threshold"));
    ...
    private void callForHelp(double signalEMA) {
        ...
        Toast.makeText(getApplicationContext(), "Noise Thersold Crossed, Starting to moniter",
                Toast.LENGTH_LONG).show();
        tv_noice.setText(signalEMA+"dB");
        Intent intent = new Intent(this, org.tensorflow.yolo.view.ClassifierActivity.class);
